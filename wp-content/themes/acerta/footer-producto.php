...
* footer-producto.php
*
* El footer de la plantilla de categorias de productos
**/
?>
  ...
  <script src="<?php echo SCRIPTS. '/jquery.eislideshow.js';?>"></script>
  ...
  <script src="<?php echo SCRIPTS. '/distribuciones.js';?>"></script>
  <script>
  ...
  <script>
      $(function() {
        ...
        $( '#contiene-marcas' ).distribuciones();
